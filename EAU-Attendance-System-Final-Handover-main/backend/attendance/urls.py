...
urlpatterns = [
    ...
    path('students/bulk-delete/',            views.StudentBulkDeleteView.as_view()),
    ...
    path('schedule-slots/',                          views.TeachingScheduleListView.as_view()),
    path('schedule-slots/<int:slot_id>/',            views.TeachingScheduleDetailView.as_view()),
